...
public class StaffPlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getCommand("invsee").setTabCompleter(staffTab);
        getCommand("give").setTabCompleter(staffTab);
        getCommand("sudo").setTabCompleter(staffTab);
        getCommand("glow").setTabCompleter(staffTab);
